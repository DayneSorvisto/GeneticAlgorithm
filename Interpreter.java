...
public static String randomProgram () { 
		...
		for (int i = 0; i < rand.nextInt(1000)+5; ++i) { 
...
public static void main (String [] args) throws IOException {
	...
	String result1 = "";
	String result2 ="";	
	while (metric(brain.code(p,0,0),GOAL) > 0) { 
	try {
		String [] pool = pool(100000,p); //make a pool of 100 000  programs at a time
...
public static String closest (String [] pool) { 
		class Metric implements Comparator<String> { 
